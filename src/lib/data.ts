...
export const thisWeekendBroadcasts: WeekendBroadcast[] = [
  {
    ...
    weekendType: "通常週末",
    channels: ["フジNEXT", "FOD"],
    note: "市街地コース78周。決勝は日本時間 6/7(日) 22:00スタート。現地時間はCEST（日本＝CEST＋7時間）。",
    sessions: [
      { session: "FP1", date: "6/5 (金)", localTime: "13:30", jst: "20:30", channels: { "フジNEXT": true, FOD: true } },
      { session: "FP2", date: "6/6 (土)", localTime: "17:00", jst: "深夜0:00", channels: { "フジNEXT": true, FOD: true } },
      { session: "FP3", date: "6/6 (土)", localTime: "12:30", jst: "19:30", channels: { "フジNEXT": true, FOD: true } },
      { session: "予選", date: "6/6 (土)", localTime: "16:00", jst: "23:00", channels: { "フジNEXT": true, FOD: true } },
      { session: "🏁 決勝（78 LAP）", date: "6/7 (日)", localTime: "15:00", jst: "22:00", channels: { "フジNEXT": true, FOD: true } },
    ],
  },
  {
    series: "F2",
    ...
    weekendType: "通常週末",
    channels: ["FOD"],
    note: "予選はグループA／Bの2組制。フィーチャーは日本時間 6/7(日) 16:35スタート。現地時間はCEST（日本＝CEST＋7時間）。",
    sessions: [
      { session: "プラクティス", date: "6/4 (木)", localTime: "15:00", jst: "22:00", channels: { FOD: true } },
      { session: "予選 グループA", date: "6/5 (金)", localTime: "15:10", jst: "22:10", channels: { FOD: true } },
      { session: "予選 グループB", date: "6/5 (金)", localTime: "15:34", jst: "22:34", channels: { FOD: true } },
      { session: "スプリント", date: "6/6 (土)", localTime: "14:15", jst: "21:15", channels: { FOD: true } },
      { session: "🏁 フィーチャー", date: "6/7 (日)", localTime: "09:35", jst: "16:35", channels: { FOD: true } },
    ],
  },
  {
    series: "F3",
    ...
    weekendType: "通常週末",
    channels: ["FOD"],
    note: "予選はグループA／Bの2組制。フィーチャーは日本時間 6/7(日) 14:55スタート。現地時間はCEST（日本＝CEST＋7時間）。",
    sessions: [
      { session: "プラクティス", date: "6/4 (木)", localTime: "13:25", jst: "20:25", channels: { FOD: true } },
      { session: "予選 グループA", date: "6/5 (金)", localTime: "10:05", jst: "17:05", channels: { FOD: true } },
      { session: "予選 グループB", date: "6/5 (金)", localTime: "11:29", jst: "18:29", channels: { FOD: true } },
      { session: "スプリント", date: "6/6 (土)", localTime: "10:45", jst: "17:45", channels: { FOD: true } },
      { session: "🏁 フィーチャー", date: "6/7 (日)", localTime: "07:55", jst: "14:55", channels: { FOD: true } },
    ],
  },
  {
    series: "INDY",
